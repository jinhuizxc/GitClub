...
import com.example.jinhui.gitclub.model.entity.Dir;
import com.example.jinhui.gitclub.model.entity.File;
import com.example.jinhui.gitclub.model.entity.GitTree;
...
import static com.example.jinhui.gitclub.common.config.Constant.PER_PAGE;
...
public class RepositoryDataSource {
    ...
    public Observable<SearchResult<RepositoryInfo>> search(String keyWord, String language, Constant.SortType.SortType_Repo sort, int page) {
        if (keyWord == null)
            keyWord = "";
