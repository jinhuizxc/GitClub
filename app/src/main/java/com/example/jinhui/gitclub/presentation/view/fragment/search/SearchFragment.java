...
public class SearchFragment extends LazyFragment
        implements SearchContract.View, SearchContract.OnListFragmentInteractListener {
    @Inject
    ...
    @Override
    public void showListRefreshLoading(@SearchContract.ListType int listType) {
        if (listType == REPO) {
    ...
    @Override
    public void showOnError(String msg, @SearchContract.ListType int type, @UpdateType int updateType) {
        showOnError(msg);
        //hide loading
        switch (type) {
            case USER:
    ...
    @Override
    public void onFetchPage(@SearchContract.ListType int type, int page) {
        switch (type) {
            case USER:
