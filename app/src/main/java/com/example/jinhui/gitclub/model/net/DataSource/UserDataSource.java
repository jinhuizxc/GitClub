...
import com.example.jinhui.gitclub.common.config.GithubConfig;
import com.example.jinhui.gitclub.common.utils.RxJavaUtils;
import com.example.jinhui.gitclub.model.entity.Authorization;
import com.example.jinhui.gitclub.model.entity.CreateAuthorization;
...
public class UserDataSource {
    ...
    public Observable<SearchResult<UserEntity>> search(String keyWord, String language, Constant.SortType.SortType_User sort, int page) {
        if (keyWord == null)
            keyWord = "";
